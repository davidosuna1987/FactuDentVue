        ...
        <form class="form" method="POST" action="{{ route('password.request') }}" role="form">
            ...
            <div class="field{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <p class="control has-icons-left">
                    <input id="email" type="email" class="input is-small {{ $errors->has('email') ? 'is-danger' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
            ...
            <div class="field{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <p class="control has-icons-left">
                    <input id="password" type="password" class="input is-small {{ $errors->has('password') ? 'is-danger' : '' }}" name="password" required>
            ...
            <div class="field{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <p class="control has-icons-left">
                    <input id="password_confirmation" type="password" class="input is-small {{ $errors->has('password_confirmation') ? 'is-danger' : '' }}" name="password_confirmation" required>
                    <span class="icon is-small is-left"><i class="fa fa-lock"></i></span>
