...
@section('content')
	...
	<div class="columns">
		<div class="column">
			...
			<div class="title title-secondary has-text-white">Editar clínica</div>
			{{-- <hr> --}}
		</div>
	</div>
				...
				<div class="column">
					...
					<form class="form" method="POST" action="{{route('clinics.update', $clinic)}}" role="form">
					    ...
					    <div class="columns">
					    	<div class="column is-one-third p-b-0">
					    		<div class="field{{ $errors->has('name') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="name" type="text" class="input is-small {{ $errors->has('name') ? 'is-danger' : '' }}" name="name" value="{{$clinic->name or old('name')}}">
					    	...
					    	<div class="column is-one-third p-b-0">
					    		<div class="field{{ $errors->has('contact') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="contact" type="text" class="input is-small {{ $errors->has('contact') ? 'is-danger' : '' }}" name="contact" value="{{$clinic->contact or old('contact')}}">
					    	...
					    	<div class="column is-one-third p-b-0">
					    		<div class="field{{ $errors->has('email') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="email" type="email" class="input is-small {{ $errors->has('email') ? 'is-danger' : '' }}" name="email" value="{{$clinic->email or old('email')}}">
					    ...
					    <div class="columns">
					    	<div class="column p-b-0">
					    		<div class="field{{ $errors->has('nif') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="nif" type="text" class="input is-small {{ $errors->has('nif') ? 'is-danger' : '' }}" name="nif" value="{{$clinic->nif or old('nif')}}">
					    	...
					    	<div class="column p-b-0">
					    		<div class="field{{ $errors->has('phone') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="phone" type="text" class="input is-small {{ $errors->has('phone') ? 'is-danger' : '' }}" name="phone" value="{{$clinic->phone or old('phone')}}">
					    	...
					    	<div class="column p-b-0">
					    		<div class="field{{ $errors->has('fax') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="fax" type="text" class="input is-small {{ $errors->has('fax') ? 'is-danger' : '' }}" name="fax" value="{{$clinic->fax or old('fax')}}">
					    	...
					    	<div class="column p-b-0 w-150">
					    		<div class="field{{ $errors->has('percentage') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="percentage" type="number" class="input is-small {{ $errors->has('percentage') ? 'is-danger' : '' }}" name="percentage" min="1" max="100" value="{{$clinic->percentage or old('percentage')}}" >
						    ...
						    <div class="column is-three-fifths p-b-0">
						    	<div class="field{{ $errors->has('address') ? ' has-error' : '' }}">
						    	    ...
						    	    <p class="control has-icons-left">
						    	        <input id="address" type="text" class="input is-small {{ $errors->has('address') ? 'is-danger' : '' }}" name="address" value="{{$clinic->address or old('address')}}">
						    ...
						    <div class="column is-two-fifths p-b-0">
						    	<div class="field{{ $errors->has('locality') ? ' has-error' : '' }}">
						    	    ...
						    	    <p class="control has-icons-left">
						    	        <input id="locality" type="text" class="input is-small {{ $errors->has('locality') ? 'is-danger' : '' }}" name="locality" value="{{$clinic->locality or old('locality')}}">
						    	        <span class="icon is-small is-left"><i class="mdi mdi-map-marker"></i></span>
					    ...
					    <div class="columns">
					    	<div class="column is-one-third">
					    		<div class="field{{ $errors->has('province') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="province" type="text" class="input is-small {{ $errors->has('province') ? 'is-danger' : '' }}" name="province" value="{{$clinic->province or old('province')}}">
					    		        <span class="icon is-small is-left"><i class="mdi mdi-map-marker"></i></span>
					    	...
					    	<div class="column is-one-third">
					    		<div class="field{{ $errors->has('country') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="country" type="text" class="input is-small {{ $errors->has('country') ? 'is-danger' : '' }}" name="country" value="{{$clinic->country or old('country')}}">
					    		        <span class="icon is-small is-left"><i class="mdi mdi-map-marker"></i></span>
					    	...
					    	<div class="column is-one-third">
					    		<div class="field{{ $errors->has('post_code') ? ' has-error' : '' }}">
					    		    ...
					    		    <p class="control has-icons-left">
					    		        <input id="post_code" type="text" class="input is-small {{ $errors->has('post_code') ? 'is-danger' : '' }}" name="post_code" value="{{$clinic->post_code or old('post_code')}}">
					    ...
					    <div class="control is-pulled-right">
					        ...
					        <button type="submit" class="button is-primary m-t-10 is-rounded">Guardar clínica</button>
					    </div>
					</form>
				</div>
			</div>
